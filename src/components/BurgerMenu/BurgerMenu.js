...
function BurgerMenu({ isOpen, onBurgerMenuOpen, onBurgerMenuClose }) {
  ...
  <section className={`burger-menu ${isOpen && 'burger-menu_open'}`}>
    <nav className={`burger-menu__container ${isOpen && 'burger-menu__container_open'}`}>
          ...
          <NavLink
					to='/'
					className={({ isActive }) => `burger-menu__nav-link ${isActive && 'burger-menu__nav-link_active'}`}>Главная</NavLink>
			  </li>
			  <li className='burger-menu__nav-list-item'>
          <NavLink
					to='/movies'
					className={({ isActive }) => `burger-menu__nav-link ${isActive && 'burger-menu__nav-link_active'}`}>Фильмы</NavLink>
			  </li>
			  <li className='burger-menu__nav-list-item'>
          <NavLink
					to='/saved-movies'
					className={({ isActive }) => `burger-menu__nav-link ${isActive && 'burger-menu__nav-link_active'}`}>Сохранённые фильмы</NavLink>
			  </li>
			</ul>
